...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/view/menu/ListMenuItemView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-void
.end method

.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ListMenuItemView;Landroid/view/View;IIFILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/appcompat/v7/_ListMenuItemView;
    ...
    invoke-direct {p6, p2, p3, p4}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V

    .line 1178
    .local p6, "layoutParams":Landroid/widget/LinearLayout$LayoutParams;
    move-object v0, p6
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ListMenuItemView;Landroid/view/View;IIFLkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-direct {p7, p2, p3, p4}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V

    .line 1167
    .local p7, "layoutParams":Landroid/widget/LinearLayout$LayoutParams;
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ListMenuItemView;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/appcompat/v7/_ListMenuItemView;
    .param p1, "$receiver"    # Landroid/view/View;
    .param p2, "width"    # I
    ...
    invoke-direct {p5, p2, p3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    .line 1156
    .local p5, "layoutParams":Landroid/widget/LinearLayout$LayoutParams;
    move-object v0, p5
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ListMenuItemView;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-direct {p6, p2, p3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V
...
.method public final lparams(Landroid/view/View;IIF)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3, p4}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$MarginLayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/LinearLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/widget/LinearLayout$LayoutParams;)Landroid/view/View;
    ...
    .param p1, "$receiver"    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p2, "source"    # Landroid/widget/LinearLayout$LayoutParams;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/LinearLayout$LayoutParams;-><init>(Landroid/widget/LinearLayout$LayoutParams;)V
