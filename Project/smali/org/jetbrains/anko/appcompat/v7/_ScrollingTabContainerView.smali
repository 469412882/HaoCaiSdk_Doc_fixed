...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ScrollingTabContainerView;Landroid/view/View;IIIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/appcompat/v7/_ScrollingTabContainerView;
    ...
    invoke-direct {p6, p2, p3, p4}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V

    .line 1178
    .local p6, "layoutParams":Landroid/widget/FrameLayout$LayoutParams;
    move-object v0, p6
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ScrollingTabContainerView;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/appcompat/v7/_ScrollingTabContainerView;
    .param p1, "$receiver"    # Landroid/view/View;
    .param p2, "width"    # I
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ScrollingTabContainerView;Landroid/view/View;IIILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-direct {p7, p2, p3, p4}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V

    .line 1167
    .local p7, "layoutParams":Landroid/widget/FrameLayout$LayoutParams;
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ScrollingTabContainerView;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-direct {p6, p2, p3}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V
...
.method public final lparams(Landroid/view/View;III)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3, p4}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/widget/FrameLayout$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/FrameLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$MarginLayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/FrameLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/widget/FrameLayout$LayoutParams;)Landroid/view/View;
    ...
    .param p1, "$receiver"    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p2, "source"    # Landroid/widget/FrameLayout$LayoutParams;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/FrameLayout$LayoutParams;-><init>(Landroid/widget/FrameLayout$LayoutParams;)V
