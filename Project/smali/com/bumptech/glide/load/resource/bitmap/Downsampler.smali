...
.method public decode(Ljava/io/InputStream;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;IILcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v1, v15, v13}, Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;-><init>(Ljava/io/InputStream;[B)V
    ...
    :try_start_0
    invoke-virtual {v7, v1}, Lcom/bumptech/glide/util/ExceptionCatchingInputStream;->mark(I)V
    :try_end_0
    ...
    invoke-direct {v4, v7}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v4}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->getOrientation()I
    ...
    invoke-virtual {v4, v6, v9, v14}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->getDimensions(Lcom/bumptech/glide/util/MarkEnforcingInputStream;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;)[I
    ...
    invoke-static {v5}, Lcom/bumptech/glide/load/resource/bitmap/TransformationUtils;->getExifOrientationDegrees(I)I
    ...
    .local v14, "exceptionStream":Lcom/bumptech/glide/util/ExceptionCatchingInputStream;
    ...
    .local v20, "bufferedStream":Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;
    :try_start_a
    ...
    .line 165
    .restart local v1    # "downsampled":Landroid/graphics/Bitmap;
    .restart local v2    # "streamException":Ljava/lang/Exception;
    .restart local v8    # "sampleSize":I
    .restart local v15    # "orientation":I
    .restart local v17    # "degreesToRotate":I
    .restart local v18    # "inWidth":I
    .restart local v19    # "inHeight":I
    ...
    .line 167
    invoke-static {v1, v10, v15}, Lcom/bumptech/glide/load/resource/bitmap/TransformationUtils;->rotateImageExif(Landroid/graphics/Bitmap;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;I)Landroid/graphics/Bitmap;
    ...
    .end local v20    # "bufferedStream":Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;
    .local v2, "orientation":I
    ...
    .restart local v20    # "bufferedStream":Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;
    :goto_4
    :try_start_c
