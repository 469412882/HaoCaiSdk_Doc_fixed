...
.method public fetchManagerServer()Lcom/qihoo360/replugin/packages/IPluginManagerServer;
    ...
    .line 1071
    .local v2, "_result":Lcom/qihoo360/replugin/packages/IPluginManagerServer;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 1071
    .end local v2    # "_result":Lcom/qihoo360/replugin/packages/IPluginManagerServer;
    :catchall_0
    move-exception v2
...
.method public listPlugins()Ljava/util/List;
    ...
    .line 601
    .local v2, "_result":Ljava/util/List;, "Ljava/util/List<Lcom/qihoo360/replugin/model/PluginInfo;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 601
    .end local v2    # "_result":Ljava/util/List;, "Ljava/util/List<Lcom/qihoo360/replugin/model/PluginInfo;>;"
    :catchall_0
    move-exception v2
...
.method public pluginDownloaded(Ljava/lang/String;)Lcom/qihoo360/replugin/model/PluginInfo;
    ...
    .line 833
    .local v2, "_result":Lcom/qihoo360/replugin/model/PluginInfo;
    goto :goto_0

    .line 836
    .end local v2    # "_result":Lcom/qihoo360/replugin/model/PluginInfo;
    :cond_0
    const/4 v2, 0x0

    .line 840
    .restart local v2    # "_result":Lcom/qihoo360/replugin/model/PluginInfo;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
...
.method public regReceiver(Ljava/lang/String;Ljava/util/Map;)V
    .locals 5
    .param p1, "plugin"    # Ljava/lang/String;
    .param p2, "receiverFilterMap"    # Ljava/util/Map;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public sendIntent2Plugin(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 919
    :goto_0
    iget-object v1, p0, Lcom/qihoo360/loader2/IPluginHost$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public startPluginProcess(Ljava/lang/String;ILcom/qihoo360/loader2/PluginBinderInfo;)Lcom/qihoo360/loader2/IPluginClient;
    ...
    .line 550
    invoke-virtual {p3, v0, v3}, Lcom/qihoo360/loader2/PluginBinderInfo;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {v3}, Lcom/qihoo360/loader2/IPluginClient$Stub;->asInterface(Landroid/os/IBinder;)Lcom/qihoo360/loader2/IPluginClient;
    ...
    .line 558
    .local v2, "_result":Lcom/qihoo360/loader2/IPluginClient;
    invoke-virtual {v1}, Landroid/os/Parcel;->readInt()I
    ...
    .line 563
    .end local v2    # "_result":Lcom/qihoo360/loader2/IPluginClient;
    :catchall_0
    move-exception v3

    .line 563
    .restart local v2    # "_result":Lcom/qihoo360/loader2/IPluginClient;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
