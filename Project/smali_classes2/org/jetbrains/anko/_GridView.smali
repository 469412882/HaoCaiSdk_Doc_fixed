...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_GridView;Landroid/view/View;IIIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/_GridView;
    ...
    .line 2163
    new-instance p6, Landroid/widget/AbsListView$LayoutParams;

    invoke-direct {p6, p2, p3, p4}, Landroid/widget/AbsListView$LayoutParams;-><init>(III)V

    .line 2164
    .local p6, "layoutParams":Landroid/widget/AbsListView$LayoutParams;
    move-object v0, p6
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_GridView;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/_GridView;
    .param p1, "$receiver"    # Landroid/view/View;
    .param p2, "width"    # I
    ...
    .line 2141
    new-instance p5, Landroid/widget/AbsListView$LayoutParams;

    invoke-direct {p5, p2, p3}, Landroid/widget/AbsListView$LayoutParams;-><init>(II)V

    .line 2142
    .local p5, "layoutParams":Landroid/widget/AbsListView$LayoutParams;
    move-object v0, p5
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_GridView;Landroid/view/View;IIILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    .line 2152
    new-instance p7, Landroid/widget/AbsListView$LayoutParams;

    invoke-direct {p7, p2, p3, p4}, Landroid/widget/AbsListView$LayoutParams;-><init>(III)V

    .line 2153
    .local p7, "layoutParams":Landroid/widget/AbsListView$LayoutParams;
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_GridView;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-direct {p6, p2, p3}, Landroid/widget/AbsListView$LayoutParams;-><init>(II)V
...
.method public final lparams(Landroid/view/View;II)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3}, Landroid/widget/AbsListView$LayoutParams;-><init>(II)V
...
.method public final lparams(Landroid/view/View;III)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3, p4}, Landroid/widget/AbsListView$LayoutParams;-><init>(III)V
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/widget/AbsListView$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/AbsListView$LayoutParams;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
