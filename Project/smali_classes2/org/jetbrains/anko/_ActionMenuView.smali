.class public Lorg/jetbrains/anko/_ActionMenuView;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroid/view/View;Landroid/widget/ActionMenuView$LayoutParams;)Landroid/view/View;",
        "(Landroid/view/View;Landroid/widget/ActionMenuView$LayoutParams;Lkotlin/jvm/functions/Function1;)Landroid/view/View;",
        "width",
        "",
        "height",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 217
    invoke-direct {p0, p1}, Landroid/widget/ActionMenuView;-><init>(Landroid/content/Context;)V

    return-void
.end method

.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_ActionMenuView;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/_ActionMenuView;
    ...
    .line 2141
    new-instance p5, Landroid/widget/ActionMenuView$LayoutParams;

    invoke-direct {p5, p2, p3}, Landroid/widget/ActionMenuView$LayoutParams;-><init>(II)V

    .line 2142
    .local p5, "layoutParams":Landroid/widget/ActionMenuView$LayoutParams;
    move-object v0, p5
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_ActionMenuView;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/_ActionMenuView;
    .param p1, "$receiver"    # Landroid/view/View;
    .param p2, "width"    # I
    ...
    .line 2131
    new-instance p6, Landroid/widget/ActionMenuView$LayoutParams;

    invoke-direct {p6, p2, p3}, Landroid/widget/ActionMenuView$LayoutParams;-><init>(II)V

    .line 2132
    .local p6, "layoutParams":Landroid/widget/ActionMenuView$LayoutParams;
...
.method public final lparams(Landroid/view/View;II)Landroid/view/View;
    ...
    .line 290
    new-instance v1, Landroid/widget/ActionMenuView$LayoutParams;

    invoke-direct {v1, p2, p3}, Landroid/widget/ActionMenuView$LayoutParams;-><init>(II)V

    .line 291
    .local v1, "layoutParams":Landroid/widget/ActionMenuView$LayoutParams;
    move-object v2, v1
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/widget/ActionMenuView$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    .param p1, "$receiver"    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p2, "other"    # Landroid/view/ViewGroup$LayoutParams;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/ActionMenuView$LayoutParams;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/widget/ActionMenuView$LayoutParams;)Landroid/view/View;
    .locals 3
    .param p1, "$receiver"    # Landroid/view/View;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2, "other"    # Landroid/widget/ActionMenuView$LayoutParams;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/ActionMenuView$LayoutParams;-><init>(Landroid/widget/ActionMenuView$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/widget/ActionMenuView$LayoutParams;Lkotlin/jvm/functions/Function1;)Landroid/view/View;
    .locals 3
    .param p1, "$receiver"    # Landroid/view/View;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
