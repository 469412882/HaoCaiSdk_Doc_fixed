...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/support/v4/_DrawerLayout;Landroid/view/View;IIIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/support/v4/_DrawerLayout;
    ...
    .line 565
    new-instance p6, Landroid/support/v4/widget/DrawerLayout$LayoutParams;

    invoke-direct {p6, p2, p3, p4}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(III)V

    .line 566
    .local p6, "layoutParams":Landroid/support/v4/widget/DrawerLayout$LayoutParams;
    move-object v0, p6
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/support/v4/_DrawerLayout;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/support/v4/_DrawerLayout;
    .param p1, "$receiver"    # Landroid/view/View;
    .param p2, "width"    # I
    ...
    .line 543
    new-instance p5, Landroid/support/v4/widget/DrawerLayout$LayoutParams;

    invoke-direct {p5, p2, p3}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(II)V

    .line 544
    .local p5, "layoutParams":Landroid/support/v4/widget/DrawerLayout$LayoutParams;
    move-object v0, p5
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/support/v4/_DrawerLayout;Landroid/view/View;IIILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    .line 554
    new-instance p7, Landroid/support/v4/widget/DrawerLayout$LayoutParams;

    invoke-direct {p7, p2, p3, p4}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(III)V

    .line 555
    .local p7, "layoutParams":Landroid/support/v4/widget/DrawerLayout$LayoutParams;
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/support/v4/_DrawerLayout;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    invoke-direct {p6, p2, p3}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(II)V
...
.method public final lparams(Landroid/view/View;II)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(II)V
...
.method public final lparams(Landroid/view/View;III)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3, p4}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(III)V
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/support/v4/widget/DrawerLayout$LayoutParams;)Landroid/view/View;
    .locals 3
    .param p1, "$receiver"    # Landroid/view/View;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p2, "source"    # Landroid/support/v4/widget/DrawerLayout$LayoutParams;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(Landroid/support/v4/widget/DrawerLayout$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/support/v4/widget/DrawerLayout$LayoutParams;Lkotlin/jvm/functions/Function1;)Landroid/view/View;
    .locals 3
    .param p1, "$receiver"    # Landroid/view/View;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$MarginLayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/support/v4/widget/DrawerLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
