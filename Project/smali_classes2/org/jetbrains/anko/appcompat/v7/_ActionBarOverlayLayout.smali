...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ActionBarOverlayLayout;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/appcompat/v7/_ActionBarOverlayLayout;
    ...
    .line 1155
    new-instance p5, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;

    invoke-direct {p5, p2, p3}, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;-><init>(II)V

    .line 1156
    .local p5, "layoutParams":Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;
    move-object v0, p5
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/appcompat/v7/_ActionBarOverlayLayout;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    .line 1145
    new-instance p6, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;

    invoke-direct {p6, p2, p3}, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;-><init>(II)V

    .line 1146
    .local p6, "layoutParams":Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;
...
.method public final lparams(Landroid/view/View;II)Landroid/view/View;
    ...
    invoke-direct {v1, p2, p3}, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;-><init>(II)V

    .line 302
    .local v1, "layoutParams":Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;
    move-object v2, v1
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$MarginLayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
