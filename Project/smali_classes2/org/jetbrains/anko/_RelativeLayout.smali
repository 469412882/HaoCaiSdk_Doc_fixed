...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_RelativeLayout;Landroid/view/View;IIILjava/lang/Object;)Landroid/view/View;
    .locals 1
    .param p0, "this"    # Lorg/jetbrains/anko/_RelativeLayout;
    ...
    invoke-direct {p5, p2, p3}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    .line 2142
    .local p5, "layoutParams":Landroid/widget/RelativeLayout$LayoutParams;
    move-object v0, p5
...
.method public static bridge synthetic lparams$default(Lorg/jetbrains/anko/_RelativeLayout;Landroid/view/View;IILkotlin/jvm/functions/Function1;ILjava/lang/Object;)Landroid/view/View;
    ...
    .line 2132
    .local p6, "layoutParams":Landroid/widget/RelativeLayout$LayoutParams;
...
.method public final lparams(Landroid/view/View;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :cond_1
    invoke-direct {v1, p2, p3}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/view/ViewGroup$MarginLayoutParams;)Landroid/view/View;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public final lparams(Landroid/view/View;Landroid/widget/RelativeLayout$LayoutParams;)Landroid/view/View;
    ...
    .param p1, "$receiver"    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p2, "source"    # Landroid/widget/RelativeLayout$LayoutParams;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    :cond_0
    invoke-direct {v1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(Landroid/widget/RelativeLayout$LayoutParams;)V
