...
.method private a(Lcn/jiguang/d/b/a/a;Ljava/net/DatagramSocket;[B)I
    ...
    iget v2, v0, Lcn/jiguang/d/b/a/c;->b:I

    invoke-static {v1, v2, p2, p3}, Lcn/jiguang/d/b/a/d;->a(Ljava/lang/String;ILjava/net/DatagramSocket;[B)I

    move-result v1

    if-nez v1, :cond_0

    const-string p1, "SisContext"

    new-instance p2, Ljava/lang/StringBuilder;

    const-string p3, "report at "
...
.method public static a([B)Lcn/jiguang/d/b/a/b;
    ...
    :try_start_2
    invoke-static {v1}, Lcn/jiguang/d/g/h;->b([B)[B
...
.method private static a(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    const-string v2, "packageSisSendBuf origin size = "
    ...
    :try_start_0
    invoke-static {p1}, Lcn/jiguang/d/g/h;->a([B)[B
...
.method public final f()V
    ...
    invoke-direct {p0, v3, v0, v2}, Lcn/jiguang/d/b/a/d;->a(Lcn/jiguang/d/b/a/a;Ljava/net/DatagramSocket;[B)I

    move-result v3

    if-eqz v3, :cond_2

    sget-object v3, Lcn/jiguang/d/a;->f:Lcn/jiguang/c/b;

    invoke-interface {v3}, Lcn/jiguang/c/b;->e()Ljava/lang/String;

    move-result-object v3

    invoke-static {v3}, Lcn/jiguang/d/c/f;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    const/4 v4, 0x0

    invoke-static {v3, v4}, Lcn/jiguang/d/b/a/a;->a(Ljava/util/List;Z)Lcn/jiguang/d/b/a/a;
