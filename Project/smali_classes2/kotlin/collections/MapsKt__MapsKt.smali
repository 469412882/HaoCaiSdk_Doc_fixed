...
.method public static final filter(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 737
    .local v3, "$receiver$iv":Ljava/util/Map;
    ...
    .end local v3    # "$receiver$iv":Ljava/util/Map;
    return-object v2
.end method
...
.method public static final filterNot(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 748
    .end local v1    # "$i$f$filterNotTo":I
    .end local v3    # "$receiver$iv":Ljava/util/Map;
    return-object v2
.end method
...
.method public static final varargs hashMapOf([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    .line 106
    .local v2, "$receiver":Ljava/util/HashMap;
    move-object v3, v2
    ...
    .end local v2    # "$receiver":Ljava/util/HashMap;
    return-object v1
.end method
...
.method public static final mapKeys(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 732
    .local v4, "$receiver$iv$iv":Ljava/lang/Iterable;
    const/4 v5, 0x0
    ...
    .line 733
    .local v5, "$i$a$1$associateByTo":I
    :goto_0
    ...
    .line 732
    .end local v5    # "$i$a$1$associateByTo":I
    ...
    .line 736
    .end local v0    # "$i$f$mapKeysTo":I
    .end local v3    # "$receiver$iv":Ljava/util/Map;
    .end local v4    # "$receiver$iv$iv":Ljava/lang/Iterable;
...
.method public static final mapKeysTo(Ljava/util/Map;Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 723
    .local v4, "$i$a$1$associateByTo":I
    :goto_0
    ...
    .line 321
    .end local v4    # "$i$a$1$associateByTo":I
    ...
    .line 726
    .end local v1    # "$i$f$associateByTo":I
...
.method public static final mapValues(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 731
    .end local v0    # "$i$f$mapValuesTo":I
    .end local v3    # "$receiver$iv":Ljava/util/Map;
    .end local v4    # "$receiver$iv$iv":Ljava/lang/Iterable;
    .end local v6    # "$i$f$associateByTo":I
    return-object v2
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .line 643
    .local v2, "$receiver":Ljava/util/Map;
    ...
    .end local v2    # "$receiver":Ljava/util/Map;
...
.method public static final varargs mutableMapOf([Lkotlin/Pair;)Ljava/util/Map;
    ...
    .line 90
    .local v2, "$receiver":Ljava/util/LinkedHashMap;
    move-object v3, v2
    ...
    .line 90
    .end local v0    # "$i$a$1$apply":I
    .end local v2    # "$receiver":Ljava/util/LinkedHashMap;
    check-cast v1, Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 583
    .local v2, "$receiver":Ljava/util/LinkedHashMap;
    invoke-virtual {v2, p1}, Ljava/util/LinkedHashMap;->putAll(Ljava/util/Map;)V

    .line 583
    .end local v0    # "$i$a$5$apply":I
    .end local v2    # "$receiver":Ljava/util/LinkedHashMap;
    check-cast v1, Ljava/util/Map;
...
.method public static final toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 511
    .local v1, "$receiver":Ljava/util/Map;
    invoke-static {v1, p0}, Lkotlin/collections/MapsKt;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
...
.method public static final toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 717
    .local v1, "$receiver":Ljava/util/Map$Entry;
    ...
    .end local v1    # "$receiver":Ljava/util/Map$Entry;
