...
.method public static final mapNotNull(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/List;
    ...
    .line 216
    .local v4, "$receiver$iv$iv":Ljava/util/Map;
    const/4 v5, 0x0
    ...
    .line 219
    .end local v4    # "$receiver$iv$iv":Ljava/util/Map;
    .end local v6    # "$i$f$forEach":I
    nop

    .line 219
    .end local v0    # "$i$f$mapNotNullTo":I
    .end local v3    # "$receiver$iv":Ljava/util/Map;
    move-object v0, v2
...
.method private static final maxBy(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map$Entry;
    ...
    .line 223
    .end local v1    # "$i$f$maxBy":I
    const/4 v1, 0x0

    goto :goto_1

    .line 224
    .restart local v1    # "$i$f$maxBy":I
    :cond_0
    invoke-interface {v3}, Ljava/util/Iterator;->next()Ljava/lang/Object;
...
.method public static final minBy(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map$Entry;
    ...
    .line 236
    .end local v1    # "$i$f$minBy":I
    const/4 v1, 0x0

    goto :goto_1

    .line 237
    .restart local v1    # "$i$f$minBy":I
    :cond_0
    invoke-interface {v3}, Ljava/util/Iterator;->next()Ljava/lang/Object;
