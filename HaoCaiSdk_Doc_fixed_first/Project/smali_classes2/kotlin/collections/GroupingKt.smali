...
.method public static final aggregate(Lkotlin/collections/Grouping;Lkotlin/jvm/functions/Function4;)Ljava/util/Map;
    ...
    invoke-interface {v3, v5}, Lkotlin/collections/Grouping;->keyOf(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 321
    .end local v1    # "$i$f$aggregateTo":I
...
.method public static final eachCount(Lkotlin/collections/Grouping;)Ljava/util/Map;
    ...
    .line 241
    .restart local v9    # "$i$a$1$foldTo":I
    :cond_1
    ...
    .end local v23    # "$receiver":Lkotlin/jvm/internal/Ref$IntRef;
    .local v1, "$receiver":Lkotlin/jvm/internal/Ref$IntRef;
    .local v24, "$receiver$iv":Lkotlin/collections/Grouping;
    ...
    .line 368
    .end local v9    # "$i$a$1$foldTo":I
    .end local v24    # "$receiver$iv":Lkotlin/collections/Grouping;
    ...
    .restart local v24    # "$receiver$iv":Lkotlin/collections/Grouping;
    nop
    ...
    .line 243
    .local v22, "$i$a$3$mapValuesInPlace":I
    :goto_3
    invoke-interface {v1}, Ljava/util/Iterator;->hasNext()Z
    ...
    .end local v22    # "$i$a$3$mapValuesInPlace":I
    ...
    .restart local v22    # "$i$a$3$mapValuesInPlace":I
    :cond_3
...
.method public static final eachCountTo(Lkotlin/collections/Grouping;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 369
    .local v5, "$receiver$iv":Lkotlin/collections/Grouping;
    nop
    ...
    .line 257
    .end local v1    # "$i$f$foldTo":I
    .end local v4    # "initialValue$iv":Ljava/lang/Object;
    .end local v5    # "$receiver$iv":Lkotlin/collections/Grouping;
    return-object v0
.end method
...
.method public static final reduce(Lkotlin/collections/Grouping;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .line 196
    .local v1, "$i$f$aggregate":I
    const/4 v2, 0x0

    .line 196
    .local v2, "$i$f$reduce":I
    const-string v3, "$receiver"
    ...
    .line 198
    .end local v18    # "$i$f$aggregate":I
    .restart local v1    # "$i$f$aggregate":I
    ...
    invoke-interface {v0, v15, v7, v1}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v16    # "acc":Ljava/lang/Object;
    .end local v17    # "e":Ljava/lang/Object;
    .restart local v18    # "$i$f$aggregate":I
    goto :goto_2
...
.method public static final reduceTo(Lkotlin/collections/Grouping;Ljava/util/Map;Lkotlin/jvm/functions/Function3;)Ljava/util/Map;
    ...
    .line 226
    .end local v0    # "$i$f$aggregateTo":I
    .end local v2    # "$receiver$iv":Lkotlin/collections/Grouping;
    return-object p1
.end method
