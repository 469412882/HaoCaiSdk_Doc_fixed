...
.method private analyzePixels()V
    ...
    .line 316
    .local v2, "nq":Lcom/bumptech/glide/gifencoder/NeuQuant;
    ...
    invoke-virtual {v2, v5, v6, v7}, Lcom/bumptech/glide/gifencoder/NeuQuant;->map(III)I
    ...
    .line 336
    iget-object v3, p0, Lcom/bumptech/glide/gifencoder/AnimatedGifEncoder;->transparent:Ljava/lang/Integer;

    invoke-virtual {v3}, Ljava/lang/Integer;->intValue()I

    move-result v3

    invoke-direct {p0, v3}, Lcom/bumptech/glide/gifencoder/AnimatedGifEncoder;->findClosest(I)I

    move-result v3

    iput v3, p0, Lcom/bumptech/glide/gifencoder/AnimatedGifEncoder;->transIndex:I
...
.method private getImagePixels()V
    ...
    .end local v6    # "len$":I
    .end local v12    # "pixelsIndex":I
    .restart local v7    # "pixelsIndex":I
    :cond_3
    ...
    const-string v3, "got pixels for frame with "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v5, v6}, Ljava/lang/StringBuilder;->append(D)Ljava/lang/StringBuilder;

    const-string v3, "% transparent pixels"
