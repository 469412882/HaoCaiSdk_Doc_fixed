...
.method static synthetic access$200(Lcom/liulishuo/filedownloader/QueuesHandler;)Landroid/util/SparseArray;
    .locals 1
    .param p0, "x0"    # Lcom/liulishuo/filedownloader/QueuesHandler;
...
.method private onAssembledTasksToStart(ILjava/util/List;Lcom/liulishuo/filedownloader/FileDownloadListener;Z)Z
    ...
    .line 120
    .local p2, "list":Ljava/util/List;, "Ljava/util/List<Lcom/liulishuo/filedownloader/BaseDownloadTask$IRunningTask;>;"
    ...
    const-string v4, "Tasks with the listener can\'t start, because can\'t find any task with the provided listener, maybe tasks instance has been started in the past, so they are all are inUsing, if in this case, you can use [BaseDownloadTask#reuse] to reuse theme first then start again: [%s, %B]"
    ...
    .line 130
    invoke-static {v0, v4, v2}, Lcom/liulishuo/filedownloader/util/FileDownloadLog;->w(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public freezeAllSerialQueues()V
    ...
    invoke-direct {p0, v2}, Lcom/liulishuo/filedownloader/QueuesHandler;->freezeSerialHandler(Landroid/os/Handler;)V
...
.method public startQueueParallel(Lcom/liulishuo/filedownloader/FileDownloadListener;)Z
    ...
    .line 50
    .local v1, "list":Ljava/util/List;, "Ljava/util/List<Lcom/liulishuo/filedownloader/BaseDownloadTask$IRunningTask;>;"
    const/4 v2, 0x0
    ...
    invoke-interface {v3}, Lcom/liulishuo/filedownloader/BaseDownloadTask$IRunningTask;->startTaskByQueue()V
...
.method public startQueueSerial(Lcom/liulishuo/filedownloader/FileDownloadListener;)Z
    ...
    .line 64
    .local v0, "callback":Lcom/liulishuo/filedownloader/QueuesHandler$SerialHandlerCallback;
    invoke-virtual {v0}, Ljava/lang/Object;->hashCode()I

    move-result v1

    .line 66
    .local v1, "attachKey":I
    invoke-static {}, Lcom/liulishuo/filedownloader/FileDownloadList;->getImpl()Lcom/liulishuo/filedownloader/FileDownloadList;
    ...
    .line 69
    .local v2, "list":Ljava/util/List;, "Ljava/util/List<Lcom/liulishuo/filedownloader/BaseDownloadTask$IRunningTask;>;"
    const/4 v3, 0x1
    ...
    .line 76
    .local v4, "serialThread":Landroid/os/HandlerThread;
    ...
    .line 79
    .local v6, "serialHandler":Landroid/os/Handler;
    invoke-virtual {v0, v6}, Lcom/liulishuo/filedownloader/QueuesHandler$SerialHandlerCallback;->setHandler(Landroid/os/Handler;)V
    ...
    .line 84
    iget-object v5, p0, Lcom/liulishuo/filedownloader/QueuesHandler;->mRunningSerialMap:Landroid/util/SparseArray;

    monitor-enter v5

    .line 85
    :try_start_0
    iget-object v7, p0, Lcom/liulishuo/filedownloader/QueuesHandler;->mRunningSerialMap:Landroid/util/SparseArray;
...
.method public unFreezeSerialQueues(Ljava/util/List;)V
    ...
    .line 102
    .local p1, "attachKeyList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    ...
    .line 103
    .local v1, "attachKey":Ljava/lang/Integer;
    iget-object v2, p0, Lcom/liulishuo/filedownloader/QueuesHandler;->mRunningSerialMap:Landroid/util/SparseArray;
    ...
    .line 104
    .local v2, "handler":Landroid/os/Handler;
    invoke-direct {p0, v2}, Lcom/liulishuo/filedownloader/QueuesHandler;->unFreezeSerialHandler(Landroid/os/Handler;)V

    .line 105
    .end local v1    # "attachKey":Ljava/lang/Integer;
    .end local v2    # "handler":Landroid/os/Handler;
    goto :goto_0
